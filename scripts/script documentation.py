# Create the features documentation
features_md = '''---
layout: page
...
more_files = {
    "docs/features.md": features_md,
    "docs/api.md": api_md
}

for filename, content in more_files.items():
    with open(filename, 'w', encoding='utf-8') as f:
        f.write(content)
    print(f"✅ Created {filename}")

print(f"\n🌟 {len(more_files)} more documentation files created!")
print("📚 Features and API documentation complete!")